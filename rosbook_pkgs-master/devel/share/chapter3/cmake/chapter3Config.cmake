...
if("TRUE" STREQUAL "TRUE")
  set(chapter3_SOURCE_PREFIX /home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/src/chapter3)
  set(chapter3_DEVEL_PREFIX /home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/devel)
  set(chapter3_INSTALL_PREFIX "")
  set(chapter3_PREFIX ${chapter3_DEVEL_PREFIX})
else()
  set(chapter3_SOURCE_PREFIX "")
  set(chapter3_DEVEL_PREFIX "")
  set(chapter3_INSTALL_PREFIX /home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'chapter3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ryodo <ryodo@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'chapter3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/src/chapter3/${idir}'.  Ask the maintainer 'ryodo <ryodo@todo.todo>' to fix it.")
    endif()
