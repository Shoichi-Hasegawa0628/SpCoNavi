...
if("TRUE" STREQUAL "TRUE")
  set(chapter5_SOURCE_PREFIX /home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/src/chapter5)
  set(chapter5_DEVEL_PREFIX /home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/devel)
  set(chapter5_INSTALL_PREFIX "")
  set(chapter5_PREFIX ${chapter5_DEVEL_PREFIX})
else()
  set(chapter5_SOURCE_PREFIX "")
  set(chapter5_DEVEL_PREFIX "")
  set(chapter5_INSTALL_PREFIX /home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'chapter5' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'RyodoTanaka <k104073r@mail.kyutech.jp>, MoriKen <p595201m@mail.kyutech.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'chapter5' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/akira/Dropbox/SpCoNavi/rosbook_pkgs-master/src/chapter5/${idir}'.  Ask the maintainer 'RyodoTanaka <k104073r@mail.kyutech.jp>, MoriKen <p595201m@mail.kyutech.jp>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${chapter5_dep}_FOUND)
      find_package(${chapter5_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${chapter5_dep} REQUIRED ${depend_list})
  endif()
