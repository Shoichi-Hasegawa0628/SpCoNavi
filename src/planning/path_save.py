...
class Simple_odom_simulator():
    ...
    def __init__(self):
        ...
        self.emu_odom_pub = rospy.Publisher("/hsrb/odom", Odometry, queue_size=50)
        ...
        if self.subscribe_cmd_vel == True:
            self.cmdvel_sub = rospy.Subscriber("/hsrb/command_velocity", Twist, self.cb_get_cmdvel_subscriber)
