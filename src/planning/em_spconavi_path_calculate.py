...
class PathPlanner:
    ...
    def PathPlanner(self, S_Nbest, X_init, THETA, CostMapProb): #gridmap, costmap):
        ...
        if (os.path.isfile(output) == False) or (UPDATE_PostProbMap == 1):  #すでにファイルがあれば作成しない
            ...
            athWeightMap = PostProbMap_nparray_jit(CostMapProb,Mu,Sig,Phi_l,LookupTable_ProbCt,map_length,map_width,L,K) #,IndexMap) 
