...
class Simple_path_simulator():
    ...
    def get_poses_from_csvdata(self, idx):
        ...
        pose_list.pose.position.y = self.csv_path_data[idx][0]
    ...
    def get_poses_from_csvdata(self):
        ...
        pose_list.target_pose.pose.position.x = self.csv_path_data[999][1]
        pose_list.target_pose.pose.position.y = self.csv_path_data[999][2]
