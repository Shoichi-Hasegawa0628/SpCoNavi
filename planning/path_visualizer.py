...
if __name__ == '__main__': 
    ...
    plt.savefig(output + '_Path.eps', dpi=300)#, transparent=True
    plt.savefig(output + '_Path.png', dpi=300)#, transparent=True
    plt.savefig(output + '_Path.pdf', dpi=300)#, transparent=True
