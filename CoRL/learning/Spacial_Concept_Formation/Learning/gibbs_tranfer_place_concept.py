...
function_increment=hyper_para[10]
iteration = 1001 
#=====rate of word cut=============================
cut_prob=1.0
#==================================================
...
#======================================Reading Data===========================================
    ...
    for e,dir in enumerate(Traing_list):
        ...
        if args.function_not==e:
            ...
            function=Description_Function_data_read(dir,function_increment,DATA_NUM,test_data_num)
    ...
    for iter in xrange(iteration):
        ...
        #<<<<<Sampling class index C_t<<<<
            ...
            G_set[e]=np.random.dirichlet(class_count_e+(gamma*G_0)+50)+1e-100
